...
- **UX-First Problem Solving:** When facing complex state logic or "guessing" user intent, always evaluate if the issue stems from poor UI clarity. Prioritize making options explicit and visible in the main interface over adding "invisible" logic or complex state handlers. Clear UI often eliminates the need for complex code.

...
- **Meaningful Commits:** Commit messages MUST describe the actual changes or features implemented. Avoid referencing internal "phases" or "stages". Always use the imperative mood and adhere to Conventional Commits.

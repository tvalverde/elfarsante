...
const newStrings = {
  ...
  result: {
    ...
    farsante_win_numbers: "¡Victoria de los Farsantes! Han logrado superar en número a los inocentes.",
  ...
  score: {
    ...
    abort_modal_desc: "¿Estás seguro de que quieres cancelar el torneo y volver a la configuración inicial?",
  ...
  system_menu: {
    ...
    sync_desc: "Para recuperar tu historial o compartir partida con otro dispositivo, introduce su código:",
    ...
    abort_tournament_desc: "¿Estás seguro de que quieres cancelar el torneo en curso y volver al inicio?",
    yes_abort: "SÍ, ABORTAR"
  }
};
